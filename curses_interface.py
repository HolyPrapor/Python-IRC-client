...
class UserInterfacePlugin:
    ...
    def make_windows(self):
        ...
        self.inputWin = curses.newwin(
            self.inputWinH, self.screenW, self.nickWinH + self.borderSize, 0
        )
        self.chatWin = curses.newwin(self.chatWinH, self.chatWinW, 0, 0)
        self.nickWin = curses.newwin(
            self.nickWinH, self.nickWinW, 0, self.chatWinW + self.borderSize
        )
        self.dbgBorder = curses.newwin(
            self.dbgWinH, self.dbgWinW, self.dbgWinY, self.dbgWinX
        )
        self.dbgWin = curses.newwin(
            self.dbgWinH - 2,
            self.dbgWinW - 2,
            self.dbgWinY + 1,
            self.dbgWinX + 1,
    ...
    def clear_input_window(self):
        ...
        self.inputWin.addstr(
            self.ircHandle.get_nick()
            + "@"
